    ...
    try:
        with Session(engine, expire_on_commit=False) as session:
            ...
            later_shot = Shot(
                ...
                sequence_number=2,
                duration_ms=5000,
                brief_segment_codes=["SEG_02"], continuity_relation="same_moment", shot_purpose="develop",
                framing="medium", camera_angle="eye_level", camera_motion="locked", subject_motion="moderate",
                face_visibility="not_visible",
                text_policy="forbidden",
                new_information="Second", generation_requirements={"reference_image_required": False, "multi_frame_required": False, "identity_consistency_required": False, "precise_text_required": False},
                composition="Second",
                action="Second",
            )
            earlier_shot = Shot(
                ...
                sequence_number=1,
                duration_ms=5000,
                brief_segment_codes=["SEG_01"], continuity_relation="same_moment", shot_purpose="establish",
                framing="medium", camera_angle="eye_level", camera_motion="locked", subject_motion="moderate",
                face_visibility="not_visible",
                text_policy="forbidden",
                new_information="First", generation_requirements={"reference_image_required": False, "multi_frame_required": False, "identity_consistency_required": False, "precise_text_required": False},
                composition="First",
                action="First",
            )
    ...
    try:
        with Session(engine, expire_on_commit=False) as session:
            ...
            later_shot = Shot(
                ...
                duration_ms=5000,
                brief_segment_codes=["SEG_02"], continuity_relation="same_moment", shot_purpose="develop",
                framing="medium", camera_angle="eye_level", camera_motion="tracking", subject_motion="significant",
                character_entity_version_ids=[active_version.id],
                outfit_entity_version_ids=[],
                face_visibility="required",
                text_policy="forbidden",
                new_information="Run", generation_requirements={"reference_image_required": False, "multi_frame_required": False, "identity_consistency_required": False, "precise_text_required": False},
                composition="Medium",
                action="Run",
            )
            earlier_shot = Shot(
                ...
                duration_ms=5000,
                brief_segment_codes=["SEG_01"], continuity_relation="same_moment", shot_purpose="establish",
                framing="wide", camera_angle="eye_level", camera_motion="locked", subject_motion="subtle",
                scene_entity_version_id=scene_version.id,
                character_entity_version_ids=[],
                outfit_entity_version_ids=[],
                face_visibility="not_visible",
                text_policy="forbidden",
                new_information="Arena", generation_requirements={"reference_image_required": False, "multi_frame_required": False, "identity_consistency_required": False, "precise_text_required": False},
                composition="Wide",
    ...
    try:
        with Session(engine, expire_on_commit=False) as session:
            ...
            shot = Shot(
                ...
                sequence_number=1,
                duration_ms=10000,
                brief_segment_codes=["SEG_01"], continuity_relation="same_moment", shot_purpose="develop",
                framing="medium", camera_angle="eye_level", camera_motion="tracking", subject_motion="significant",
            ...
            other_shot = Shot(
                ...
                face_visibility="not_visible",
                text_policy="forbidden",
                new_information="Other", generation_requirements={"reference_image_required": False, "multi_frame_required": False, "identity_consistency_required": False, "precise_text_required": False},
                composition="Wide",
                action="Other",
            )
            earlier_asset = Asset(
