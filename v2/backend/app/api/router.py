...
@router.post(
    "/projects/{project_id}/timelines/{timeline_id}:review-preview",
    response_model=TimelinePreviewReviewRead,
)
def project_timeline_review_preview(
    project_id: str,
    timeline_id: str,
    ...
    try:
        return review_timeline_preview(
            session,
            require_project(session, project_id),
            timeline_id,
            payload,
