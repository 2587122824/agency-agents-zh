"""Require complete context around real-time cut observations.

Revision ID: 20260811_48
Revises: 20260811_47
"""
...
revision = "20260811_48"
down_revision = "20260811_47"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    op.execute(
        sa.text(
            ...
            "SET schema_version = 'editor-draft-session.v6', "
