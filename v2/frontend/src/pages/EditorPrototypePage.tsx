...
export function EditorPrototypePage() {
  ...
  const [editorDraftRestoreComplete, setEditorDraftRestoreComplete] = useState(false)
  ...
  useEffect(() => {
    ...
    replaceBoundaryCandidateReviewSessions({})
    setEditorDraftRestoreComplete(false)
    setBoundaryContinuityObservations({})
    setBoundaryContinuityReadyEvidence({})
    setDirty(false)
  ...
  useEffect(() => {
    ...
    setEditorDraftRestoreComplete(true)
  ...
  useEffect(() => {
    if (!editorDraftRestoreComplete || !sourceTimeline || !dirty || !items.length || boundaryRollMonitor?.active) return
  ...
  }, [boundaryCandidateReviewSessions, boundaryContinuityIssueContexts, boundaryContinuityObservations, boundaryContinuityOutcomes, boundaryRollMonitor, dirty, editorDraftRestoreComplete, items, localDraftKey, playheadMs, snapEnabled, sourceTimeline, timelineZoom])
