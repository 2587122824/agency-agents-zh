...
当前配置 v42 提供 6 个可执行镜头工作流槽位：通用参考图关键帧 `2072296894507872257`、纯文本关键帧 `2069402773254397953`、人物一致性关键帧 `2073414172825706497`、风格参考关键帧 `2066342754241835010`、首帧生视频 `2069607607387639810`、纯文本 B-roll 视频 `2071227330307125249`。每个槽位都有严格语义 NodeInfoList、支持规格和测试价格规则；v41 修正 v40 继承的工作流中文显示名编码，v42 修正配置标题编码，不改变六个工作流的槽位主键、供应商工作流 ID、节点合同、能力、规格或价格。
