...
| Repository 接口 | 部分完成 | 已完成 Project/Event/Decision/Command/Creation/Planning/Production/Quality/Editor/Delivery/Work 协议、SQLAlchemy 实现和合同测试；核心命令服务与 Worker 已无直接 ORM 查询，其余配置和只读投影仍待迁移 |
