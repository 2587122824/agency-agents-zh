...
| 工作流槽位注册表 | 已完成 | 当前配置 v50 提供 6 个严格可执行镜头槽位：纯文本、人物一致性、风格参考三种关键帧，以及首帧生视频、首中尾帧生视频、纯文本 B-roll 三种视频。`2072296894507872257` 已按权威预设登记为首中尾帧生视频，精确绑定 `447 / 448 / 449` 三张父图；错误的生图槽位已移除。v50 只修正本地素材库连接引用，工作流路由不变 |
