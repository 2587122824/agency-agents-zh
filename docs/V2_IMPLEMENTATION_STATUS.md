...
| 工作流槽位注册表 | 已完成 | 当前配置 v39 提供 6 个严格可执行镜头槽位：参考图、纯文本、人物一致性、风格参考四种关键帧，首帧生视频和纯文本 B-roll 两种视频。每项具有语义 NodeInfoList、规格与测试价格；V1 空 ID、错误 ID、受污染映射和尚无多参考合同的槽位明确不迁入 |
