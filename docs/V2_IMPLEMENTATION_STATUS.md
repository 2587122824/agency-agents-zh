...
| Repository 接口 | 部分完成 | 已完成 Project/Event/Decision/Command/Creation/Planning/Production/Quality/Editor/Delivery 协议、SQLAlchemy 实现和合同测试；创作、规划、生产、质量、剪辑和交付服务已无直接 ORM 查询，其余聚合仍待迁移 |
