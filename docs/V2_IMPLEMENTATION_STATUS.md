...
| Repository 接口 | 部分完成 | 已完成 Project/Event/Decision/Command/Creation/Planning/Production/Quality/Editor 协议、SQLAlchemy 实现和合同测试；创作、规划、生产、质量和剪辑服务已无直接 ORM 查询，其余聚合仍待迁移 |
